...
- **Notifications** — use Laravel database notifications. Notification payloads include a `kind` field (`task_assigned`, `comment_reply`) consumed by `NotificationBell.vue`.
